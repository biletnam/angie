...
echo $this->loadAnyTemplate('steps/steps', ['helpurl' => 'https://www.akeebabackup.com/documentation/solo/angie-joomla-setup.html']);
?>
	...
	<div class="akeeba-container--50-50">
		...
		<div class="akeeba-panel--orange">
			...
			<?php if ($this->htaccessSupported): ?>
				<div class="akeeba-form-group--checkbox--pull-right">
					<label <?php echo $this->replaceHtaccessOptions['disabled'] ?>>
						<input type="checkbox" value="1" id="replacehtaccess"
							   name="replacehtaccess" <?php echo $this->replaceHtaccessOptions['disabled'] ?> <?php echo $this->replaceHtaccessOptions['checked'] ?> />
						<?php echo AText::_('SETUP_LBL_SERVERCONFIG_REPLACEHTACCESS'); ?>
					</label>
					<span class="akeeba-help-text" style="display: none">
						  <?php echo AText::_($this->replaceHtaccessOptions['help']) ?>
					</span>
				</div>
			<?php endif; ?>
